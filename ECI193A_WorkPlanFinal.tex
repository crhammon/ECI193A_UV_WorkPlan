...
\usetikzlibrary{calc}
\definecolor{lime}{RGB}{50,100,255}
...
\begin{titlepage}
    \begin{tikzpicture}[overlay,remember picture]
        \fill[lime!5] (current page.south east) rectangle (current page.north west);
        \fill[lime,even odd rule] (current page.south west) rectangle ([xshift=2cm]current page.north west) ($(current page.north west)!.0!(current page.south west)$) arc(200:425:2);
        ...
        \node[yshift=+4cm,black] at (2.5,-7) {\scalebox{4}{Work Plan}};

        \node[yshift=+1cm,black] at (8,-7) {\scalebox{2}{UV System Replacement/UVT Requirement Reduction}};

        \node[yshift=-1cm,black] at (2.2,-7) {\scalebox{2}{\it pHlux Engineering}};
