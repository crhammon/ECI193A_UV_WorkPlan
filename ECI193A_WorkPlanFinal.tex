...
\begin{table}[htbp]
    ...
    Manning's n values for cement, grass, and brick were approximated as unfinished cement, short-grass pasture, and brick with cement mortar. The values were obtained from \cite{White},\cite{USDA}, and\cite{HEC}, respectively.
